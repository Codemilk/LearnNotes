...
#隔离等级
#在SpringBoot主配置文件中配置日志隔离等级
logging.level.springbootstudy=trace 

#日志输出目录
#不指定将路径生成当前项目下
#指定的话将当前文件生成在指定路径下
logging.file.name=Spring_log/springBoot.log
...
Simple expressions:（表达式语法）
    Variable Expressions: ${...}：获取变量值；OGNL；
            ...
            3）、内置的一些工具对象：
                ...
                #messages : methods for obtaining externalized messages inside variables expressions, in the same                   wayas they would be obtained using #{…} syntax.
